...
# %%
d_fake=pd.read_csv(r"C:\Users\Apoorv Nigam\Downloads\Fake.csv")
d_true=pd.read_csv(r"C:\Users\Apoorv Nigam\Downloads\True.csv")
...
# %%
data = d_merge.drop(['title','subject','date'],axis = 1)
